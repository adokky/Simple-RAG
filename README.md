...
## Ручная реализация RAG пайплайна

Альтернативная версия приложения, где langchain4j используется только для прямого доступа к моделям.
Можно посмотреть [здесь](https://github.com/adokky/Simple-RAG/tree/6c1f3878dec5fb4e0dfd45a3f5774b877347100f). Отличия:

* Реализация схемы БД для хранения документов.
* Векторный поиск через сырой SQL запрос.
* Ручная векторизация и вставка документов в БД. 
